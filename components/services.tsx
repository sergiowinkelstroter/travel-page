    ...
    <div className="my-40 mx-10 md:mx-auto">
      ...
      <div className="mt-10 mb-10 flex flex-col items-center justify-center">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          {/* small blocks */}
          <div className="group flex h-16 w-auto cursor-pointer items-center justify-center gap-8 rounded-xl border border-violet-600 hover:shadow-xl px-8 hover:bg-violet-600 transition-colors">
